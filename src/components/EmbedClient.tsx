    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <div className="flex justify-center px-4 py-14">
        ...
        >
          ...
          <p>
            Copy and Paste this code before <span>&lt;/body&gt;</span>
          </p>
          <div className="relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10">
            ...
            <button
              className="absolute top-3 right-3 bg-white text-zinc-900 text-xs font-medium px-3
                    py-1.5 rounded-lg hover:bg-zinc-200 transition cursor-pointer"
              onClick={copyCode}
            >
              {copied ? "Copied ✓" : "Copy"}
            </button>
          ...
          <div className="mt-14">
            ...
            <div className="rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden">
              ...
              <div className="relative h-64 sm:h-72 p-6 text-zinc-400 text-sm">
                ...
                <div
                  className="absolute bottom-24 right-6 w-64 bg-white rounded-xl shadow-xl border
