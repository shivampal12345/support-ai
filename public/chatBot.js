(function () {
    ...
    const api_Url = "https://support-ai-ruddy-chi.vercel.app/api/chat";
    ...
    <button id="chat-send" style="padding:8px 12px; border:none; background:#000; color:#fff; border-radius:8px;
    font-size:13px; cursor:pointer; ">Send</button>
    </div>
     `
